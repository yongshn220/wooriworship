...
import { useServingTimeline } from "../../serving-form/hooks/use-serving-timeline";
import { useServingTemplates } from "../../serving-form/hooks/use-serving-templates";
import { useServingHistory } from "../../serving-form/hooks/use-serving-history";
...
export function useServiceFlowFormLogic({ teamId, serviceId, initialFlow, serviceTagIds = [], onCompleted }: UseServiceFlowFormLogicProps) {
    ...
    const { getSuggestionsForTitle } = useServingHistory(teamId, serviceTagIds, teamMembers);
