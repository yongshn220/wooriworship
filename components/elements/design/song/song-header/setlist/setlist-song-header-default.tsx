...
export function SetlistSongHeaderDefault({ teamId, songId, customTags = [], selectedMusicSheetIds = null }: Props) {
...
/** @deprecated Use SetlistSongHeaderDefault instead */
export const WorshipSongHeaderDefault = SetlistSongHeaderDefault;
