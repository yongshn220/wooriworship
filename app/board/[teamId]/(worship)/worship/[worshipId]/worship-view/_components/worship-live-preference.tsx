...
import {worshipLiveOptionsAtom, worshipMultipleSheetsViewModeAtom, worshipViewPageModeAtom} from "@/app/board/[teamId]/(worship)/worship/[worshipId]/_states/worship-detail-states";
