...
// import {TagMultiSelect} from "@/app/board/[teamId]/song-board/_components/tag-multi-select";
// import {Textarea} from "@/components/ui/textarea";
// import {useToast} from "@/components/ui/use-toast";
// import MultipleImageUploader from "@/app/board/[teamId]/song-board/_components/multiple-image-uploader";
// import {MusicSheetCard} from "@/app/board/[teamId]/song-board/_components/music-sheet-card";
...
// import {currentTeamSongIdsAtom, songAtom, songUpdaterAtom} from "@/global-states/song-board-state";
// import useViewportHeight from "@/components/hook/use-viewport-height";
// import PdfUploader from "@/app/board/[teamId]/song-board/_components/pdf-uploader";
...
//   const song-board = useRecoilValue(songAtom(songId))
...
//     title: (mode === FormMode.EDIT)? song-board?.title?? "" : "",
//     subtitle: (mode === FormMode.EDIT)? song-board?.subtitle?? "" : "",
//     author: (mode === FormMode.EDIT)? song-board?.original.author?? "" : "",
//     version: (mode === FormMode.EDIT)? song-board?.version?? "" : "",
//     link: (mode === FormMode.EDIT)? song-board?.original.url?? "" : "",
//     tags: (mode === FormMode.EDIT)? song-board?.tags?? [] : [],
//     bpm: (mode === FormMode.EDIT)? song-board?.bpm?? null : null,
//     description: (mode === FormMode.EDIT)? song-board?.description?? "" : ""
//   })
...
//         toast({description: `Fail to create a song-board. Please try again.`})
//         return
//       }
//
...
//       console.log("err", e)
//       toast({
//         description: `Fail to create a song-board. Please try again.`,
//       })
//     }
//     finally {
//       clearContents()
...
//     if (!authUser?.uid|| (song-board == null || song-board.id == null)) {
//       setIsOpen(false)
//       setIsLoading(false)
//       toast({
...
//         promises.push(MusicSheetService.updateMusicSheet(authUser?.uid, song-board?.id, mContainer))
//       })
//       // Update Song and tags
//       promises.push(SongService.updateSong(authUser?.uid, song-board?.id, songInput, musicSheetContainers));
