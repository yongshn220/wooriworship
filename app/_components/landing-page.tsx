...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen w-full flex overflow-hidden bg-white relative selection:bg-blue-100">
      {/* Background Ambience */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] left-[-20%] w-[80%] h-[80%] rounded-full bg-blue-100/50 blur-[120px] mix-blend-multiply animate-pulse" />
      ...
      <div className="hidden lg:flex w-1/2 relative bg-transparent text-slate-800 p-12 flex-col justify-between z-10 border-r border-slate-100/50 backdrop-blur-sm">
          ...
          >
            <div className="relative mb-12 group perspective-1000">
              ...
              <motion.div
                ...
                className="relative z-10 rounded-2xl overflow-hidden shadow-2xl shadow-blue-200/50 border border-white/60 bg-white/40 backdrop-blur-md p-6"
              >
                <Image
              ...
              {/* Decorative Elements */}
              <div className="absolute -z-10 top-10 -right-10 w-24 h-24 bg-blue-400/20 rounded-full blur-2xl animate-blob" />
            ...
            <h1 className="text-6xl font-bold tracking-tight mb-6 leading-[1.1] text-slate-900">
              Manage your <br />
              worship team <br />
        ...
        <div className="relative z-10 text-sm text-slate-500 font-light flex items-center gap-2">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-4 sm:p-8 relative z-10">
        ...
        <div className="w-full max-w-md relative">
          ...
          <div className="absolute -inset-4 bg-gradient-to-r from-blue-400/30 to-indigo-400/30 rounded-[3rem] blur-2xl opacity-40 pointer-events-none" />
